...
const problem = trimText(data?.problem || "ไม่มีรายละเอียด", 160);
    ...
    // ========= วาดข้อความ =========
drawText(`เคสด่วน ${case_code}`, 120, 320, {
  font: 'bold 40px "ThaiBold", sans-serif',
  color: "#000000",
  maxWidth: 800
});

drawText(`ชื่อ: ${full_name}`, 120, 390, {
  font: 'bold 34px "ThaiBold", sans-serif',
  color: "#000000",
  maxWidth: 800
});

drawText(`โทร: ${phone}`, 120, 445, {
  font: 'bold 30px "ThaiRegular", sans-serif',
  color: "#000000",
  maxWidth: 800
});

drawText(`พื้นที่: ${location}`, 120, 500, {
  font: 'bold 30px "ThaiRegular", sans-serif',
  color: "#000000",
  maxWidth: 800
});

drawText(`รายละเอียด: ${problem}`, 120, 575, {
  font: 'bold 30px "ThaiRegular", sans-serif',
  color: "#000000",
  maxWidth: 800
});
