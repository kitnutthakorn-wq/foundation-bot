...
const problem = trimText(data?.problem || "ไม่มีรายละเอียด", 160);
    ...
    // ========= วาดข้อความ =========
drawText(`เคสด่วน ${case_code}`, 655, 285, {
  font: 'bold 34px "ThaiBold", sans-serif',
  color: "#000000",
  maxWidth: 470
});

drawText(`ชื่อ: ${full_name}`, 655, 338, {
  font: 'bold 28px "ThaiBold", sans-serif',
  color: "#000000",
  maxWidth: 470
});

drawText(`โทร: ${phone}`, 655, 392, {
  font: 'bold 24px "ThaiRegular", sans-serif',
  color: "#000000",
  maxWidth: 470
});

drawText(`พื้นที่: ${location}`, 655, 446, {
  font: 'bold 24px "ThaiRegular", sans-serif',
  color: "#000000",
  maxWidth: 470
});

drawText(`รายละเอียด: ${problem}`, 655, 520, {
  font: 'bold 24px "ThaiRegular", sans-serif',
  color: "#000000",
  maxWidth: 470
});
